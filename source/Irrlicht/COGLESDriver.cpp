...

{
    ...
    core::dimension2d<u32> WindowSize(640, 480);
	...
	gContext = SDL_GL_CreateContext((SDL_Window*) ExposedData.SDLData.Window);
	//this->gContext=ExposedData.SDLData.Context;

	if (params.Vsync)
    SDL_GL_SetSwapInterval( 0 ); else SDL_GL_SetSwapInterval( 1 ); 
...
IVideoDriver* createOGLES1Driver(const SIrrlichtCreationParameters& params,
		io::IFileSystem* io
#if defined(_IRR_COMPILE_WITH_X11_DEVICE_) || defined(_IRR_WINDOWS_API_) || defined(_IRR_ANDROID_PLATFORM_)
        , IContextManager* contextManager
